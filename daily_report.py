...
try:
    ...
    def main():
        ...
        print(f"Збираємо дані за {day}")
        f = aggregate_finance(day)
        print("Агреговані фінанси:", f)

        s = get_session()
        s.execute(text("""
            INSERT INTO daily_reports(day,orders_count,orders_ads_count,sales_total,avg_check,ad_cost,manager_cost,avg_margin,gross_profit,net_profit,
